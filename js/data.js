...
(function (global) {
  ...
  var CONTENT_VERSION = '2026-08-19.6';
  ...
  var DEFAULT_DATA = {
    ...
    settings: {
      ...
      heroTitle: 'Hương liệu chuẩn quốc tế<br>từ hãng <span class="txt-givaudan">Givaudan</span><br>cho <span class="txt-accent">mỹ phẩm &amp; thực phẩm</span>',
      ...
      /* Địa chỉ nhận form (Formspree, EmailJS, Google Form…). Khi điền vào đây,
         ...
         Đang trỏ tới form Formspree có người nhận là mai.pham@quangthang.vn
         (không dùng lại form xwleedde cũ vì Formspree không cho đổi người
         nhận của một form sau khi đã tạo — phải tạo form mới). */
      formEndpoint: 'https://formspree.io/f/mwleaayd',
      /* Endpoint RIÊNG cho loại yêu cầu "Yêu cầu báo giá" — để trống thì các
         ...
         muốn báo giá vào thẳng hộp thư một nhân sự khác với hộp thư chung
         phía trên (VD: một nhân sự kinh doanh riêng), tách khỏi hộp thư
         chung. Tạo form Formspree thứ 2, đặt email nhận là hộp thư mong
         muốn, dán endpoint vào đây. Hiện để trống vì toàn bộ email đã dùng
         chung 1 hộp thư (mai.pham@quangthang.vn) ở formEndpoint phía trên. */
      quoteFormEndpoint: '',
