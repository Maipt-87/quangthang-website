  ...
  var DEFAULT_DATA = {
    ...
    settings: {
      ...
      stats: [
        ...
        { value: 250, suffix: '+', label: 'Khách hàng bao gồm các nhà máy, cơ sở sản xuất, hộ kinh doanh' },
    ...
    categories: [
      { id: 'personal-care', name: 'Hương cho Personal Care', desc: 'Hương cho dầu gội, sữa tắm, sữa rửa mặt, kem dưỡng da và các sản phẩm chăm sóc tóc, chăm sóc da.', image: IMG + 'prod-silk-hair.jpg' },
      { id: 'home-care', name: 'Hương cho Home Care', desc: 'Hương cho nước giặt, nước xả, nước rửa chén, lau sàn, xịt tẩy rửa, nến thơm và tinh dầu khuếch tán không gian.', image: IMG + 'prod-calm-diffuser.jpg' },
      { id: 'fine-fragrance', name: 'Hương cho Fine Fragrance', desc: 'Hương cao cấp cho nước hoa (Eau de Parfum/Toilette) và body mist, theo xu hướng quốc tế.', image: IMG + 'prod-bloom-elegance.jpg' },
      { id: 'incense', name: 'Hương cho Nhang – Trầm', desc: 'Dòng hương chuyên biệt dành riêng cho sản xuất nhang, trầm hương và các sản phẩm xông thơm truyền thống.', image: IMG + 'prod-noir-intense.jpg' },
      { id: 'food', name: 'Hương cho Thực phẩm', desc: 'Hương cho kem, sữa, bánh kẹo, trà, kẹo dẻo, nước giải khát và các sản phẩm thực phẩm chế biến.', image: IMG + 'prod-strawberry-cream.jpg' }
    ],
    ...
    industries: [
      ...
      },
      {
        ...
        image: IMG + 'prod-bloom-elegance.jpg',
      ...
      },
      {
        ...
        image: IMG + 'prod-strawberry-cream.jpg',
      ...
      },
      {
        id: 'home-care',
        name: 'Hoá mỹ phẩm',
        image: IMG + 'prod-citrus-multiclean.jpg',
